...
public class GBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(GBlockTags.PINK_SALT_BLOCKS).add(GBlocks.PINK_SALT.get(), GBlocks.ROSE_PINK_SALT.get(), GBlocks.PASTEL_PINK_SALT.get());
        this.tag(GBlockTags.PINK_SALT_HEATED_BLOCKS).add(Blocks.SOUL_CAMPFIRE, Blocks.SOUL_FIRE);
        this.tag(GBlockTags.OMIT_ASTRAL).add(Blocks.BEDROCK);
        this.tag(GBlockTags.OASIS_REPLACE).addTag(GBlockTags.PINK_SALT_BLOCKS).addTag(BlockTags.DIRT).addTag(BlockTags.BASE_STONE_OVERWORLD).addTag(BlockTags.FLOWERS).addTag(Tags.Blocks.ORES);
