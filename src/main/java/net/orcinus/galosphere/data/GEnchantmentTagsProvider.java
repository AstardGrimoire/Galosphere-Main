...
public class GEnchantmentTagsProvider extends EnchantmentTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        this.tag(GEnchantmentTags.PINK_SALT_SHRINE_LOOT).add(GEnchantments.ENFEEBLE).add(GEnchantments.SUSTAIN).add(GEnchantments.RUPTURE).add(Enchantments.UNBREAKING);
    }
