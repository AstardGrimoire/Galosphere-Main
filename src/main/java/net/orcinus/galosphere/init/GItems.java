...
public class GItems {
    ...
    public static final Item PRESERVED_SPAWN_EGG = register("preserved_spawn_egg", new SpawnEggItem(GEntityTypes.PRESERVED, 15703431, 7246179, new Item.Properties()));
    ...
    public static final Item PINK_SALT_SHARD = registerBaseItem("pink_salt_shard");
