...
public class GStructureProcessorTypes {
    ...
    public static final Supplier<StructureProcessorType<MainRoomProcessor>> PINK_SALT_MAIN_ROOM = register("pink_salt_main_room", MainRoomProcessor.CODEC);
    public static final Supplier<StructureProcessorType<NoWaterloggedProcessor>> NO_WATERLOGGED = register("no_waterlogged", NoWaterloggedProcessor.CODEC);
    public static final Supplier<StructureProcessorType<RawOreProcessor>> RAW_ORES = register("raw_ores", RawOreProcessor.CODEC);
